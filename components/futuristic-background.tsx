export default function FuturisticBackground({ subtle = false }: { subtle?: boolean }) {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.08),transparent_45%),linear-gradient(180deg,rgba(3,6,18,0.5)_0%,rgba(3,6,18,0.65)_70%,rgba(3,6,18,0.86)_100%)]" />
    </div>
  )
}
